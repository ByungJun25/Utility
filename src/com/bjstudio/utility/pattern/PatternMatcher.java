...
public class PatternMatcher {
	...
	public static final String HANGUL_ALL_PATTERN="^[¤¡-¤¾¤¿-¤Ó°¡-ÆR]*$";
	public static final String HANGUL_WORD_ONLY_PATTERN="^[°¡-ÆR]*$";
	public static final String HANGUL_NUMBER_PATTERN="^[°¡-ÆR0-9]*$";
	public static final String HANGUL_ALPHABET_PATTERN = "^[°¡-ÆRa-zA-Z]*$";
	...
	public static final String CHARACTER_ONLY_PATTERN="^[¤¡-¤¾¤¿-¤Ó°¡-ÆRa-zA-Z]*$";
	public static final String CHARACTER_NUMBER_PATTERN="^[¤¡-¤¾¤¿-¤Ó°¡-ÆRa-zA-Z0-9]*$";
